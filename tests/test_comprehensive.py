...
class TestObjectDetector:
    ...
    def test_detect_image_local(self):
        ...
        results = self.detector.detect_image(test_image, save_result=False, show_result=False)
...
class TestBatchProcessor:
    ...
    def test_batch_detect_images(self):
        ...
        results = self.processor.batch_detect_images(test_folder, "test_batch_results", detection_type="object")
...
class TestVisualizer:
    ...
    def test_plot_detection_stats(self):
        ...
        results = detector.detect_image("https://ultralytics.com/images/bus.jpg", save_result=False, show_result=False)
...
class TestDatabase:
    ...
    def test_get_detections(self):
        ...
        self.db.insert_detection(
            user_id="test_user", detection_type="object", image_path="test.jpg", result={"count": 3}
        )
...
class TestResilience:
    ...
    def test_rate_limiter(self):
        """测试限流器."""
        from src.resilience import RateLimitConfig, RateLimiter
...
class TestPerformance:
    ...
    def test_detection_speed(self):
        ...
        for _ in range(10):
            detector.detect_image("https://ultralytics.com/images/bus.jpg", save_result=False, show_result=False)
    ...
    def test_batch_processing_speed(self):
        ...
        start_time = time.perf_counter()
        processor.batch_detect_images(test_folder, "test_batch_results", detection_type="object")
        end_time = time.perf_counter()
