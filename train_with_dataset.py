...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='coco2017-val',
                        choices=['coco2017', 'coco2017-val', 'openimages',
                                 'visdrone', 'custom'],
