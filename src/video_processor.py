...
class VideoProcessor:
    ...
    def process_video(
        ...
        while cap.isOpened():
            ...
            if show_result:
                try: cv2.imshow('Video Processing', annotated)
                except: pass
        ...
        if detection_type == 'object':
            ...
            if results[0].boxes is not None:
                for box in results[0].boxes:
                    ...
                    cv2.putText(annotated, f"{name} {conf:.0%}", (x1, y1-8),
            ...
            if results[0].boxes is not None:
                for box in results[0].boxes:
                    ...
                    cv2.putText(annotated, f"Face {conf:.0%}", (x1, y1-8),
...
def process_video_file(video_path: str, output_path: str = None, detection_type: str = 'object') -> Dict:
